...
$(info $(CLR_CYN)     ______                ___                _____   ____       $(CLR_RST))
$(info $(CLR_CYN)    /\__  _\              /\_ \              /\  __`\/\  _`\     $(CLR_RST))
$(info $(CLR_CYN)    \/_/\ \/    __    ____\//\ \      __     \ \ \/\ \ \,\L\_\   $(CLR_RST))
$(info $(CLR_CYN)       \ \ \  /'__`\ /',__\ \ \ \   /'__`\    \ \ \ \ \/_\__ \   $(CLR_RST))
$(info $(CLR_CYN)        \ \ \/\  __//\__, `\ \_\ \_/\ \L\.\_   \ \ \_\ \/\ \L\ \ $(CLR_RST))
$(info $(CLR_CYN)         \ \_\ \____\/\____/ /\____\ \__/.\_\   \ \_____\ `\____\$(CLR_RST))
$(info $(CLR_CYN)          \/_/\/____/\/___/  \/____/\/__/\/_/    \/_____/\/_____/$(CLR_RST))
$(info $(CLR_CYN)                                                             $(CLR_RST))
$(info $(CLR_CYN)=================================================================$(CLR_RST))
...
$(info $(CLR_BLU)  $(CLR_BOLD)$(CLR_MAG)TESLA_VERSION = $(CLR_CYN)$(TESLA_VERSION)$(CLR_RST)$(CLR_RST))
